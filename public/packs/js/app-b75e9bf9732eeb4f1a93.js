...
document.addEventListener('DOMContentLoaded', function () {
  var vm = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"]({
    el: '#app',
    data: function data() {
      return {
        results: [],
    ...
    created: function created() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("https://api.nytimes.com/svc/topstories/v2/home.json?api-key=PXryzF2iNpyTiwECgLWBDmSEoUNGk7Xg").then(function (response) {
        _this.results = response.data.results;
      });
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('https://api.coindesk.com/v1/bpi/currentprice.json') // .then(response => (this.info = response))全て
      .then(function (response) {
        return _this.info = response.data.bpi.USD.code;
      });
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("http://localhost:8000/api_v2/?format=json").then(function (response) {
        _this.django = response;
      });
    }
  });
});
...
/******/ });
//# sourceMappingURL=app-b75e9bf9732eeb4f1a93.js.map