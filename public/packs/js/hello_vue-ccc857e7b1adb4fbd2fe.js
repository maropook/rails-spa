...
// Module
exports.push([module.i, "\n.style1 {\n  font-family: \"Avenir\", Helvetica, Arial, sans-serif;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #2c3e50;\n  margin-top: 120px;\n}\n", "",{"version":3,"sources":["/Users/hasegawaitsuki/ghq/github.com/maropook/rails_api/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAgCA;EACA,mDAAA;EACA,mCAAA;EACA,kCAAA;EACA,kBAAA;EACA,cAAA;EACA,iBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div class=\"style1\">\n    <h1>{{ message }}</h1>\n    <p v-for=\"(user, key) in users\" :key=\"key\">\n      {{ user.name.title }} {{ user.name.last }}\n    </p>\n  </div>\n</template>\n\n<script>\nimport axios from 'axios';\n\nexport default {\n  data () {\n    return {\n      message: \"Hello Axios\",\n      users: [],\n    };\n  },\n  created () {\n    axios\n      .get(\"https://randomuser.me/api/\", {\n        params: {\n          results: \"10\",\n        },\n      })\n      .then((response) => (this.users = response.data.results))\n      .catch((response) => console.log(response));\n  },\n};\n</script>\n<style>\n.style1 {\n  font-family: \"Avenir\", Helvetica, Arial, sans-serif;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #2c3e50;\n  margin-top: 120px;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=hello_vue-ccc857e7b1adb4fbd2fe.js.map